...
the world table: https://sqlzoo.net/wiki/Read_the_notes_about_this_table
*/
...
/*
  ...
  Use the ROUND function: https://sqlzoo.net/wiki/ROUND
*/

SELECT
  name,
  ROUND(population/1000000.0, 2) AS 'population (MIL)',
  ROUND(gdp/1000000000.0, 2) AS 'gdp (BIL)'
FROM world
WHERE continent = 'South America'
